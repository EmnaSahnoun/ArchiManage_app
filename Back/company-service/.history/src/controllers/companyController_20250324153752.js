...
const createCompany = async (req, res) => {
  try {
    ...
    const groupResponse = await axios.post(
      ...
      {
        headers: {
          Authorization: `Bearer // Dans createCompany, remplacez la partie Keycloak par:
const mockGroupId = "mock-group-id-123";
console.warn("ATTENTION: Mock Keycloak group ID used:", mockGroupId);
// Continuez avec mockGroupId pour tester le flot MongoDB`,
